...
_RE_REGEN        = re.compile(r"\b(?:regenerate|re-generate|redo|rebuild)\b.{0,40}\b(?:slide|intro|introduction|conclusion|summary|thank you)\b|\brewrite\s+(?:conclusion|introduction|intro|summary|thank you)\s+slide\b", _R)
